...
Group.new('GitSignsAdd', colors.green, groups.Normal)
Group.new('GitSignsChange', colors.blue, groups.Normal)
Group.new('GitSignsDelete', colors.red, groups.Normal)
Group.new('MsgArea', colors.green, colors.none)
Group.new('MoreMsg', colors.green, colors.none)
Group.new('Question', colors.blue, colors.none)
Group.new('Indent1', colors.green, colors.none)
Group.new('Indent2', colors.yellow, colors.none)
Group.new('Indent3', colors.red, colors.none)
